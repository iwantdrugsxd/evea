    ...
    <div className="w-full max-w-none">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <StatCard
          ...
          value={`${vendorData?.averageRating || 0} ⭐`}
          change={2.1}
          icon={Star}
          color="bg-yellow-500"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <motion.div
          ...
          className="lg:col-span-2 bg-white/5 backdrop-blur-2xl border border-white/20 rounded-3xl p-6"
        >
          <div className="flex items-center justify-between mb-6">
      ...
      <motion.div
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6, delay: 0.6 }}
        className="mt-8 bg-white/5 backdrop-blur-2xl border border-white/20 rounded-3xl p-6"
      >
        <h3 className="text-lg font-bold text-white mb-6">Quick Actions</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Button variant="outline" className="text-green-400 border-green-500/20 hover:bg-green-500/10">
            <Calendar className="h-4 w-4 mr-2" />
            View Calendar
          </Button>
          <Button variant="outline" className="text-yellow-400 border-yellow-500/20 hover:bg-yellow-500/10">
            <MessageCircle className="h-4 w-4 mr-2" />
            Check Messages
          </Button>
          <Button variant="outline" className="text-purple-400 border-purple-500/20 hover:bg-purple-500/10">
